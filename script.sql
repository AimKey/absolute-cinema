...
VALUES (N'20250620184009_InitialCreate', N'8.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250621050041_FixUserFGKey', N'8.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250621050914_FixAuditType', N'8.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250621055123_changeUserDetailDobToNullable', N'8.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250621061351_changeBaseToNUllable', N'8.0.11');
GO
...
ALTER TABLE [MovieTags] DROP CONSTRAINT [FK_MovieTags_Tags_MovieId];
GO

CREATE INDEX [IX_MovieTags_TagId] ON [MovieTags] ([TagId]);
GO

ALTER TABLE [MovieTags] ADD CONSTRAINT [FK_MovieTags_Tags_TagId] FOREIGN KEY ([TagId]) REFERENCES [Tags] ([Id]) ON DELETE CASCADE;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250704090555_Fix_Tag_Fk', N'8.0.11');
GO
...
ALTER TABLE [MovieDirector] DROP CONSTRAINT [FK_MovieDirector_Directors_DirectorId];
GO

ALTER TABLE [MovieDirector] DROP CONSTRAINT [FK_MovieDirector_Movies_MovieId];
GO

ALTER TABLE [MovieDirector] DROP CONSTRAINT [PK_MovieDirector];
GO

EXEC sp_rename N'[MovieDirector]', N'MovieDirectors';
GO

EXEC sp_rename N'[MovieDirectors].[IX_MovieDirector_MovieId]', N'IX_MovieDirectors_MovieId', N'INDEX';
GO

EXEC sp_rename N'[MovieDirectors].[IX_MovieDirector_DirectorId]', N'IX_MovieDirectors_DirectorId', N'INDEX';
GO

ALTER TABLE [Users] ADD [Email] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [ShowtimeSeats] ADD [IsBooked] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Showtimes] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Reviews] ADD [ReviewDate] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
GO

ALTER TABLE [Reviews] ADD [UserId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
GO

ALTER TABLE [MovieDirectors] ADD CONSTRAINT [PK_MovieDirectors] PRIMARY KEY ([Id]);
GO

CREATE INDEX [IX_Reviews_UserId] ON [Reviews] ([UserId]);
GO

ALTER TABLE [MovieDirectors] ADD CONSTRAINT [FK_MovieDirectors_Directors_DirectorId] FOREIGN KEY ([DirectorId]) REFERENCES [Directors] ([Id]) ON DELETE CASCADE;
GO

ALTER TABLE [MovieDirectors] ADD CONSTRAINT [FK_MovieDirectors_Movies_MovieId] FOREIGN KEY ([MovieId]) REFERENCES [Movies] ([Id]) ON DELETE CASCADE;
GO

ALTER TABLE [Reviews] ADD CONSTRAINT [FK_Reviews_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250707054451_AddedUserEmailAndFixedReview', N'8.0.11');
GO
...
ALTER TABLE [ShowtimeSeats] DROP CONSTRAINT [FK_ShowtimeSeats_Tickets_TicketId];
GO

DROP INDEX [IX_ShowtimeSeats_TicketId] ON [ShowtimeSeats];
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[ShowtimeSeats]') AND [c].[name] = N'IsBooked');
IF @var104 IS NOT NULL EXEC(N'ALTER TABLE [ShowtimeSeats] DROP CONSTRAINT [' + @var104 + '];');
ALTER TABLE [ShowtimeSeats] DROP COLUMN [IsBooked];
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[ShowtimeSeats]') AND [c].[name] = N'TicketId');
IF @var105 IS NOT NULL EXEC(N'ALTER TABLE [ShowtimeSeats] DROP CONSTRAINT [' + @var105 + '];');
ALTER TABLE [ShowtimeSeats] ALTER COLUMN [TicketId] uniqueidentifier NULL;
GO

CREATE UNIQUE INDEX [IX_ShowtimeSeats_TicketId] ON [ShowtimeSeats] ([TicketId]) WHERE [TicketId] IS NOT NULL;
GO

ALTER TABLE [ShowtimeSeats] ADD CONSTRAINT [FK_ShowtimeSeats_Tickets_TicketId] FOREIGN KEY ([TicketId]) REFERENCES [Tickets] ([Id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250707082244_FixShowtimeSeat', N'8.0.11');
GO
...
ALTER TABLE [Bookings] DROP CONSTRAINT [FK_Bookings_Payments_PaymentId];
GO

ALTER TABLE [ShowtimeSeats] DROP CONSTRAINT [FK_ShowtimeSeats_Seats_SeatId];
GO

ALTER TABLE [ShowtimeSeats] DROP CONSTRAINT [FK_ShowtimeSeats_Showtimes_ShowtimeId];
GO

DROP INDEX [IX_Bookings_PaymentId] ON [Bookings];
GO
...
IF @var106 IS NOT NULL EXEC(N'ALTER TABLE [Bookings] DROP CONSTRAINT [' + @var106 + '];');
...
ALTER TABLE [ShowtimeSeats] ADD CONSTRAINT [FK_ShowtimeSeats_Seats_SeatId] FOREIGN KEY ([SeatId]) REFERENCES [Seats] ([Id]) ON DELETE CASCADE;
GO

ALTER TABLE [ShowtimeSeats] ADD CONSTRAINT [FK_ShowtimeSeats_Showtimes_ShowtimeId] FOREIGN KEY ([ShowtimeId]) REFERENCES [Showtimes] ([Id]) ON DELETE CASCADE;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250708164321_FixingBooking_PaymentRelation', N'8.0.11');
GO
